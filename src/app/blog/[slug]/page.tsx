...
export default async function BlogPostPage({
    ...
    const postUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://yourblog.com'}/blog/${post.slug}`;
                    ...
                    <article>
                        ...
                        {post.tags && (
                            <div style={{
                                ...
                                <span style={{ fontWeight: 600, marginRight: '1rem' }}>Tags:</span>
            ...
            {relatedPosts.length > 0 && (
                <section style={{ padding: '4rem 0', background: 'var(--secondary)' }}>
                    <div className="container">
                        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>Related Articles</h2>
