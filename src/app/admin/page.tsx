...
export default function AdminDashboard() {
  ...
  async function deleteCategory(id: string) {
    if (
      !confirm(
        "Are you sure? All posts in this category will become uncategorized."
      )
    )
      return;
  ...
  const navItems = [
    ...
    { id: "messages", label: "Inbox", icon: BarChart3 },
  ];
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
          ...
          {navItems.map((item) => (
            <button
              ...
              style={{
                ...
                marginBottom: "0.5rem",
                background:
                  activeTab === item.id ? "var(--secondary)" : "transparent",
              }}
            >
              <item.icon size={20} />
              {item.label}
      ...
      {/* Main Content */}
      <main
        style={{ flex: 1, padding: "2rem", background: "var(--background)" }}
      >
        {/* Dashboard Tab */}
        {activeTab === "dashboard" && (
          <div>
                    ...
                    {posts.slice(0, 5).map((post) => (
                      ...
                      >
                        ...
                        <td style={{ padding: "0.75rem" }}>
                          <span
                            className={`badge ${
                              post.published ? "" : "badge-secondary"
                            }`}
                          >
...
function SubscribersTab() {
  const [subscribers, setSubscribers] = useState<
    Array<{ id: string; email: string; createdAt: string; active: boolean }>
  >([]);
  const [loading, setLoading] = useState(true);
  ...
  return (
    <div>
      <h1 style={{ marginBottom: "2rem" }}>Newsletter Subscribers</h1>
      <div className="card" style={{ padding: "1.5rem" }}>
        {loading ? (
          <div
            style={{
          ...
          >
            {messages.map((msg) => (
              ...
              >
                ...
                <p style={{ lineHeight: 1.7 }}>{msg.message}</p>
              </div>
            ))}
          </div>
        ) : (
