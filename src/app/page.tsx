      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Your daily destination for insightful articles, tutorials, and tips on technology,
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/blog" className="btn" style={{
              ...
              Explore Articles <ArrowRight size={18} style={{ marginLeft: '0.5rem' }} />
            </Link>
        ...
        <div className="container" style={{ padding: '3rem 1.5rem' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <h3 style={{ fontSize: '2rem', fontWeight: 800 }}>{posts.length}+</h3>
      ...
      <section style={{ padding: '4rem 0' }}>
        <div className="container">
          <div style={{
            ...
            <div>
              <h2 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Latest Articles</h2>
              <p style={{ color: 'var(--muted)' }}>Fresh insights from our community</p>
            </div>
          ...
          {posts.length > 0 ? (
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--muted)', marginBottom: '1.5rem' }}>
                Be the first to publish! Head to the admin dashboard to create your first post.
              </p>
        ...
        <section style={{ padding: '4rem 0', background: 'var(--secondary)' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'var(--muted)' }}>Find articles that match your interests</p>
            </div>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.9)', marginBottom: '2rem', maxWidth: '500px', margin: '0 auto 2rem' }}>
                Subscribe to our newsletter and never miss a new article. Get insights delivered straight to your inbox.
              </p>
              <div style={{
                display: 'flex',
                gap: '0.75rem',
